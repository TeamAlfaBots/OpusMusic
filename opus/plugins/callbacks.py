...
from opus import Opus, app, db, lang, queue, tg, yt
from opus.helpers import admin_check, buttons, can_manage_vc


@app.on_callback_query(
    filters.regex("cancel_dl")
    & ~app.bl_users
)
@lang.language()
...
# ============================================
# SOURCE MENU CALLBACKS
# ============================================

@app.on_callback_query(
    filters.regex("^source_menu$")
    & ~app.bl_users
)
@lang.language()
